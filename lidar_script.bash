...
tmux send -t 0:0.0 "source install/local_setup.bash && source ../lidar_ws/install/local_setup.bash && ros2 launch iir_base diffbot.launch.py use_mock_hardware:=true use_lidar:=true" C-m
