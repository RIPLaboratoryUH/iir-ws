...
namespace odrive_ros2_control
{
    ...
    public:
        ...
        std::vector<double> scaled_positions_;
...
std::vector<hardware_interface::StateInterface> ODriveHardwareInterface::export_state_interfaces()
{
    ...
    for (size_t i = 0; i < info_.joints.size(); i++)
    {
        ...
        state_interfaces.emplace_back(
            hardware_interface::StateInterface(info_.joints[i].name, hardware_interface::HW_IF_POSITION, &scaled_positions_[i]));
        state_interfaces.emplace_back(
            hardware_interface::StateInterface(info_.joints[i].name, hardware_interface::HW_IF_VELOCITY, &scaled_velocities_[i]));
    }
